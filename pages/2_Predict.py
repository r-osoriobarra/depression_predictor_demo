...
if uploaded_file is not None:
   try:
       ...
       # Determine color for high risk students
       ...
       with col2:
           ...
           <div class="metrics-container">
               <div class="custom-metric">
                   <div class="metric-value" style="color: white;">{round(df["Depression Risk (%)"].mean(), 2)}%</div>
       ...
       with col3:
           ...
           <div class="metrics-container">
               <div class="custom-metric">
                   <div class="metric-value" style="color: {risk_color};">{high_risk_count}</div>
                   <div class="metric-label">High Risk Students ({high_risk_percent:.1f}%)</div>
               </div>
           </div>
           """, unsafe_allow_html=True)
